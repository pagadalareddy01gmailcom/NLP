...
Original file is located at
    https://colab.research.google.com/drive/1nDltP1sE1Fr1v-BHCG_nbPqQhbzsG45l
...
def question_seven():
    ...
    total_tokens_in_sentences = 0
    for sentence in sentences:
        total_tokens_in_sentences += len(word_tokenize(sentence))

    if len(sentences) == 0:
        return 0.0
    return float(total_tokens_in_sentences) / len(sentences)
...
def question_eight():
    ...
    filtered_words = [word.lower() for word in moby_tokens if word.isalpha() and word.lower() not in english_stopwords]
...
def question_nine():
    ...
    stemmed_tokens = [porter_stemmer.stem(word.lower()) for word in moby_tokens if word.isalpha()]
